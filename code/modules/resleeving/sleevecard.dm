...
//	show_messages = 0 // I'm unsure on what this does but it's not called in this file, ever. - Jon
...
/obj/item/device/sleevecard/see_emote(mob/living/M, text)
	if(infomorph && infomorph.client && !infomorph.anchored)

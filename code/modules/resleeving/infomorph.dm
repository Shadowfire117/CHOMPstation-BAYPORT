...
/mob/living/silicon/infomorph
	...
	idcard = /obj/item/weapon/card/id/synthetic
	var/idaccessible = 0
...
/mob/living/silicon/infomorph/verb/reset_record_view()
	...
	var/datum/data/record/securityActive1 = null
	var/datum/data/record/securityActive2 = null
	security_cannotfind = 0
	var/datum/data/record/medicalActive1 = null
	var/datum/data/record/medicalActive2 = null
...
/mob/living/silicon/infomorph/verb/radiosettings()
	...
	if(radio)
		radio.ui_interact(src,"main",null,1)
	else
...
/mob/living/silicon/infomorph/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = 1)
	if(user != src)
	...
	if (!ui)
		ui = new(user, src, ui_key, "pai_interface.tmpl", "Card Software Interface", 450, 600)

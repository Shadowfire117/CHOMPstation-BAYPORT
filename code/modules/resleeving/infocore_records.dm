...
/datum/transhuman/body_record
	...
	var/bodygender
	var/body_oocnotes
	var/list/limb_data = list(BP_HEAD, BP_L_HAND, BP_R_HAND, BP_L_ARM, BP_R_ARM, BP_L_FOOT, BP_R_FOOT, BP_L_LEG, BP_R_LEG, BP_GROIN, BP_CHEST)
	var/list/organ_data = list(BP_HEART, BP_EYES, BP_LUNGS, BP_BRAIN)

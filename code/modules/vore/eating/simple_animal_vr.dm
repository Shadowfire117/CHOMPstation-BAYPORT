...
//
/mob/living/simple_animal/proc/animal_nom(var/mob/living/T in GLOB.living_mobs(1))
	set name = "Animal Nom"
	set category = "IC"
...
/mob/living/simple_animal/verb/toggle_digestion()
	...
	if(faction == "retaliate" || (faction == "hostile" && faction != user.faction))
...
/mob/living/simple_animal/attackby(var/obj/item/O, var/mob/user)
	if (istype(O, /obj/item/weapon/newspaper) && !(ckey || (faction == "hostile" && faction != user.faction)) && isturf(user.loc))
		if (faction == "retaliate" && prob(vore_pounce_chance/2)) // This is a gamble!

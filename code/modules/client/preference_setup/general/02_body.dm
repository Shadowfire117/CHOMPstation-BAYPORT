...
/datum/preferences
	...
	var/r_skin = 238					//Skin color // CHOMPER edit, so color multi sprites can aren't BLACK AS THE VOID by default.
	var/g_skin = 206					//Skin color // CHOMPER edit, so color multi sprites can aren't BLACK AS THE VOID by default.
	var/b_skin = 179					//Skin color // CHOMPER edit, so color multi sprites can aren't BLACK AS THE VOID by default.

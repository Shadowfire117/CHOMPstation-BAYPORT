...
// DISABLING FOR NOW, NEEDS REDESIGN - JON
/*
/datum/species/xenochimera //Scree's race.
	...
	darksight_range = 8		//critters with instincts to hide in the dark need to see in the dark - about as good as tajara.
	...
	species_flags = SPECIES_FLAG_NO_SCAN | SPECIES_FLAG_NO_POISON //Dying as a chimera is, quite literally, a death sentence. Well, if it wasn't for their revive, that is.
...
/datum/species/xenochimera/proc/handle_feralness(var/mob/living/carbon/human/H)
	...
	var/shock = H.getHalLoss() > min(60, H.nutrition/10)
